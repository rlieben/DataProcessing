window.onload = function(){
	...
	// 	.offset([-10, 0])
	// 	.html(function(d) {
	// 		return "<strong>Temperature:</strong> <span style='color:red'>" + function(i){ return d[i].gemhum;} + "</span>";
	// 	});
	...
	function generateMap(error, nld, jsonified){
		...
		// inwoneraantal.forEach(function(d) {
		...
		// 	var data2 = filterJSON(inwoneraantal, 'province', provincename);
		// 	console.log(data2)
		// })
